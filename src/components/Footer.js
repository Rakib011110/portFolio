...
const Footer = () => {
    ...
    const links = [
        {
            ...
            href: "https://www.linkedin.com/in/rakibul-islam-8b3021258/",
            style: "rounded-tr-md",
        },
        {
            id: 2,
    ...
    return (
        <div className='bg-black '>
            ...
            <footer class="p-10 mx-20 bg-black sm:p-6 dark:bg- shadow-xl ">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <Link href="https://flowbite.com/" class="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-8" alt="FlowBite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">RAKIB</span>
                        </Link>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link href="https://flowbite.com/" class="hover:underline">Rakibul Islam™</Link>     . All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link alt href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
